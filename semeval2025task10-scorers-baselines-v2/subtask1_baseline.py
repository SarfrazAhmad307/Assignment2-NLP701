        ...
        with open(dev_file, mode="r", encoding="utf-8") as file:
            with open(output_file, mode="w", encoding="utf-8") as fout:
                ...
                for row in tsv_reader:
                    ...
                    writer.writerow(
                        [file_id, obj, span_start, span_end, role, sub_role]
                    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dev_file", type=str, required=True, help="Path to the input file"
    )
    parser.add_argument(
        "--output_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        required=True,
        help="Baseline type: 'random' or 'majority'",
    )
    parser.add_argument(
        "--train_file",
        type=str,
        help="Path to the training file (required for majority baseline)",
    )
